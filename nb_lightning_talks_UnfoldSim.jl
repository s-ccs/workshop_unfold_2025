...
# ╔═╡ 3a7da2b1-41d8-492e-aaf5-395910c3cdae
events = generate_events(StableRNG(1), design)

# ╔═╡ c8e51442-93c3-4059-9671-87072089be10
md"""
## 2. Event basis functions (Components)
"""

# ╔═╡ fdaa5ebd-34bd-4b7f-9626-21a727cc6e59
begin
	f_components = Figure()
...
# ╔═╡ 916c312f-6976-4827-bb43-b474ccf5abaf
begin
...
# ╔═╡ 89f33b4e-f5cc-402d-8754-f9cce1217880
md"""
## 3. Inter-onset distance distribution
"""

# ╔═╡ a62fbc05-2b2f-48e6-b9ec-5f5d47959aa3
md"""
## 4. Noise specification
"""

# ╔═╡ 27ed326b-74aa-4198-8bf2-2e3c2915a1dd
md"""
## Simulate data ⚗️🪄
"""

# ╔═╡ 438d9dcf-e23a-4263-8841-e37dd94a3f5f
md"""
Minimal event offset \
$(@bind offset PlutoUI.Slider(0:50:150, default = 100, show_value = true))
"""
...
# ╔═╡ 44d64890-22d3-4a82-8b1e-31d98bcd433c
hist(noise_samples, bins = 100);

# ╔═╡ 52beeaa6-983d-41bd-a209-ba1b4e7266b9
begin
	f_noise = Figure()
...
# ╔═╡ 276e4ab2-3a0a-4a5d-8aae-bead0548b358
...
manifest_format = "2.0"
project_hash = "bcec301ac80deea65b2d01e5e8feaa88280af0b5"
